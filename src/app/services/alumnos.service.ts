...
export class AlumnosService {
  ...
  public actualizarAlumno(data: any): Observable<any> {
    ...
    return this.http.put<any>(`${environment.url_api}/alumnos-edit/`, data, { headers }); //pasamos data porque es put
  }
  ...
  public eliminarAlumno(idAlumno: number): Observable<any> {
    ...
    return this.http.delete<any>(`${environment.url_api}/alumnos-edit/?id=${idAlumno}`, { headers }); //peticion delete
  }
