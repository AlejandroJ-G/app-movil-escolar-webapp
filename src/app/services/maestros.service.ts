...
export class MaestrosService {
  ...
  public registrarMaestro(data: any): Observable<any> {
      const dataEnviar = { ...data };

      if (Array.isArray(dataEnviar.materias_json)) {
        dataEnviar.materias_json = JSON.stringify(dataEnviar.materias_json);
      }
  ...
  return this.http.post<any>(`${environment.url_api}/maestros/`, dataEnviar, { headers });
}
  ...
  // Petición para actualizar un maestro
    public actualizarMaestro(data: any): Observable<any> {
      ...
      return this.http.put<any>(`${environment.url_api}/maestros-edit/`, dataEnviar, { headers });
    }
    ...
    public eliminarMaestro(idMaestro: number): Observable<any>{
      ...
      return this.http.delete<any>(`${environment.url_api}/maestros-edit/?id=${idMaestro}`, { headers });
    }
